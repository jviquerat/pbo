...
class ctrl_cyl_1():
    ...
    def __init__(self, path):
        ...
        self.obs_diam = [0.05,0.01]
        self.obs_pos  = [[0.0,0.0],[1.0,0.0]]

        self.r_min    = (0.5*self.obs_diam[0]+0.5*self.obs_diam[1])*1.414
        self.r_max    = self.r_min + 10.0*self.obs_diam[1]
        self.t_min    = 0.0
        self.t_max    = math.pi
    ...
    def step(self, act, ep):
        ...
        drag, success = cfd_solve(self.x_min,   self.x_max,
                                  ...
                                  self.Re,      self.obs_diam,
                                  self.obs_pos, self.path, str(ep))
