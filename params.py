...
n_avg        = 10          # nb of runs to average results
lr           = 5.0e-3     # learning rate
mu_arch      = [2,2]        # architecture for mu    network
sg_arch      = [2,2]        # architecture for sigma network
mu_epochs    = 8         # nb of epochs for mu    update
sg_epochs    = 8        # nb of epochs for sigma update
